...
void setPoints(String type, PVector[] innerPoints, PVector[] outerPoints, PVector start, PVector[] finishLine, PVector[] preFinLine, float startAngle) {
  ...
  finishLine[0] = new PVector(800, 151);
