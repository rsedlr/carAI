...
public void setPoints(String type, PVector[] innerPoints, PVector[] outerPoints, PVector[] finishLine, PVector[] preFinLine) {  // PVector start, float startAngle
  if (type == "" || type == "default") {
    ...
    outerPoints[27] = new PVector(35, 125);
    outerPoints[28] = new PVector(35, 194);
    ...
    outerPoints[35] = new PVector(35, 381);
    outerPoints[36] = new PVector(35, 444);
    ...
    outerPoints[43] = new PVector(35, 642);
    outerPoints[44] = new PVector(35, 721);
    outerPoints[45] = new PVector(125, 771);
    outerPoints[46] = new PVector(442, 773);
    outerPoints[47] = new PVector(532, 690);
    outerPoints[48] = new PVector(551, 690);
    
    innerPoints[0] = new PVector(678, 700);
    ...
    innerPoints[39] = new PVector(481, 503);
    innerPoints[40] = new PVector(482, 562);
    innerPoints[41] = new PVector(433, 613);
    innerPoints[42] = new PVector(168, 670);
    innerPoints[43] = new PVector(164, 674);
    innerPoints[44] = new PVector(164, 681);
    innerPoints[45] = new PVector(180, 685);
    innerPoints[46] = new PVector(420, 685);
