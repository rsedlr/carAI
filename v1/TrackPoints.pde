...
public void setPoints(String type, PVector[] innerPoints, PVector[] outerPoints, PVector[] finishLine, PVector[] preFinLine) {  // PVector start, float startAngle
  if (type == "" || type == "default") {
    ...
    innerPoints[0] = new PVector(747, 709);
    innerPoints[1] = new PVector(1055, 713);
    innerPoints[2] = new PVector(1089, 693);
    innerPoints[3] = new PVector(1090, 672);
    innerPoints[4] = new PVector(1053, 650);
    innerPoints[5] = new PVector(645, 601);
    innerPoints[6] = new PVector(573, 548);
    innerPoints[7] = new PVector(574, 493);
    innerPoints[8] = new PVector(649, 443);
    innerPoints[9] = new PVector(1004, 325);
    innerPoints[10] = new PVector(1053, 276);
    innerPoints[11] = new PVector(1059, 208);
    innerPoints[12] = new PVector(1035, 180);
    innerPoints[13] = new PVector(926, 148);
    innerPoints[14] = new PVector(888, 149);
    innerPoints[15] = new PVector(719, 157);
    innerPoints[16] = new PVector(711, 174);
    ...
    outerPoints[0] = new PVector(753, 782);
    outerPoints[1] = new PVector(1088, 778);
    outerPoints[2] = new PVector(1167, 730);
    outerPoints[3] = new PVector(1169, 635);
    outerPoints[4] = new PVector(1075, 582);
    outerPoints[5] = new PVector(696, 546);
    outerPoints[6] = new PVector(681, 535);
    outerPoints[7] = new PVector(683, 515);
    outerPoints[8] = new PVector(729, 493);
    outerPoints[9] = new PVector(1072, 390);
    outerPoints[10] = new PVector(1173, 292);
    outerPoints[11] = new PVector(1178, 204);
    outerPoints[12] = new PVector(1102, 122);
    outerPoints[13] = new PVector(922, 68);
    outerPoints[14] = new PVector(879, 67);
    outerPoints[15] = new PVector(688, 88);
    outerPoints[16] = new PVector(650, 116);
